...
A number of helper functions are referenced below. Those are described in detail in section TODO
- Sigma0
- Sigma1
- Ch
- Maj
...
- In the first iteration, `a ... h` are initialized with constants (see Appendix TODO or [1], section 5.3.3).
